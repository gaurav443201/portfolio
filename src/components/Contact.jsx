...
const ContactSection = () => {
    ...
    const sendEmail = (e) => {
        ...
        setTimeout(() => {
            ...
            setStatusMessage({ text: 'Message sent successfully! Gaurav will reply soon.', type: 'success' });
                ...
                <div className="w-full lg:w-5/12 flex flex-col justify-start">
                    ...
                    <div className="flex flex-col gap-10">
                        ...
                        <div className="hidden md:block">
                            ...
                            <a href="mailto:navgharegaurav80@gmail.com" className="text-xl tracking-wide hover:text-[#ccff00] transition-colors break-words font-medium">
                        ...
                        <div className="hidden md:block">
                            ...
                            <a href="tel:+918432903694" className="text-xl tracking-wide hover:text-[#ccff00] transition-colors font-medium">
                                +91 8432903694
                            </a>
                        </div>
                        ...
                        <div className="mt-4 flex flex-col items-center md:items-start">
                            ...
                            <div className="flex items-center justify-center md:justify-start gap-3">
                                ...
                                <a href="https://github.com/gaurav443201" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#ccff00] hover:text-black transition-all">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                        <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path>
                                    </svg>
                                </a>
                                <a href="mailto:navgharegaurav80@gmail.com" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#ccff00] hover:text-black transition-all">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
